...
class SiteReference(xmatters.utils.ApiBase):
    def __init__(self, parent, data):
        ...
        links = data.get('links')  #: :vartype: str
...
class Site(xmatters.utils.ApiBase):
    def __init__(self, parent, data):
        ...
        self.links = xmatters.objects.common.SelfLink(self,
                                                      links) if links else None  #: :vartype: :class:`~xmatters.objects.common.SelfLink`
