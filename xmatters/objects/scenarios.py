...
class Scenario(xmatters.utils.ApiBase):
    ...
    def __init__(self, parent, data):
        ...
        self.voicemail_options = xmatters.objects.events.VoicemailOptions(self, vm_opts) if vm_opts else None  #: :vartype: :class:`~xmatters.objects.events.VoicemailOptions`
        ...
        self.permitted = [factory.ScenarioPermFactory(self, p) for p in perm] if perm else []  #: :vartype: [:class:`~xmatters.factories.ScenarioPermFactory(self, p)]`
        ...
        conference_bridge = data.get('conferenceBridge')
        self.conference_bridge = xmatters.objects.common.ReferenceByType(self, conference_bridge) if conference_bridge else None #: :vartype: :class:`~xmatters.objects.common.ReferenceByType`
...
class ScenarioPermission(xmatters.utils.ApiBase):
    def __init__(self, parent, data):
...
class ScenarioPermissionPerson(ScenarioPermission):
    def __init__(self, parent, data):
        ...
        self.person = xmatters.objects.common.PersonReference(self,
