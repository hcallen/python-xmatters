...
class SubscriptionForm(xmatters.connection.ApiBridge):
    ...
    def visible_target_device_names(self):
        ...
        return list(
            xmatters.xm_objects.common.Pagination(self, vtdns, xmatters.factories.DeviceNameFactory)) if vtdns.get(
            'data') else []
    ...
    def property_definitions(self):
        ...
        return list(xmatters.xm_objects.common.Pagination(self, ps, xmatters.factories.PropertiesFactory)) if ps.get(
            'data') else []
    ...
    def roles(self):
        ...
        return list(xmatters.xm_objects.common.Pagination(self, roles, xmatters.xm_objects.roles.Role)) if roles else []
