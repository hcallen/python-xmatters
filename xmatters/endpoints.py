...
class AuditsEndpoint(ApiBase):
    ...
    def get_audits(self, params=None, **kwargs):
        ...
        """
        url = self._get_url()
        data = self._con.get(url=url, params=params, **kwargs)
...
class DevicesEndpoint(ApiBase):
    ...
    def update_device(self, data):
        ...
        """
        url = self._get_url()
        data = self._con.post(url=url, data=data)
        return xmatters.factories.DeviceFactory(self, data) if data else None
...
class DeviceNamesEndpoint(ApiBase):
    ...
    def get_device_names(self, params=None, **kwargs):
        ...
        url = self._get_url()
        data = self._con.get(url=url, params=params, **kwargs)
        return Pagination(self, data, xmatters.factories.DeviceNameFactory) if data.get('data') else []
...
class ImportsEndpoint(ApiBase):
    ...
    def get_import_jobs(self, params=None, **kwargs):
        ...
        """
        url = self._get_url()
        data = self._con.get(url, params=params, **kwargs).get('data', {})
